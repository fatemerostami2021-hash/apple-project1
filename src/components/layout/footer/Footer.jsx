    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-10 md:py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {[
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label={key}
                  className={`w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center ${hover} transition-all duration-300`}
                >
              ...
              {[
                ...
                <div key={label} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm break-all" dir={dir}>{value}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col items-center lg:items-end">
            ...
            <div className="mt-6 text-center">
              ...
              <div className="mt-1 text-[11px] uppercase tracking-[0.18em] text-amber-500 font-bold">
                {digitalDate}
              </div>
              <p className="mt-2 text-[10px] uppercase tracking-[0.3em] opacity-45 font-black">
                Apple Watch Ultra
              </p>
            </div>
          </div>
        ...
        <div className="mt-8 pt-5 border-t border-zinc-200 dark:border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.25em] font-black text-zinc-900 dark:text-white">
