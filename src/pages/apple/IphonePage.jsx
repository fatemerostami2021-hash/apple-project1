// src/pages/apple/IphonePage.jsx
  ...
  const models = [
    {
      ...
      description: {
        fa: "آیفون ۱۷ پرو مکس جدیدترین و پیشرفته‌ترین نسل آیفون است...",
        en: "The iPhone 17 Pro Max represents the most advanced generation..."
      }
    },
    {
      id: 16,
      ...
      description: {
        fa: "آیفون ۱۶ پرو مکس ترکیبی از قدرت، طراحی زیبا...",
        en: "The iPhone 16 Pro Max blends power, premium design..."
      }
    },
    {
      id: 15,
      ...
      description: {
        fa: "آیفون ۱۵ پرو مکس یکی از محبوب‌ترین مدل‌های آیفون است...",
        en: "The iPhone 15 Pro Max is one of the most popular iPhone models..."
      }
    },
    {
      id: 14,
      ...
      description: {
        fa: "آیفون ۱۴ پرو مکس با طراحی مدرن و ویژگی‌های نوآورانه...",
        en: "The iPhone 14 Pro Max stands out with its modern design..."
      }
    },
    {
      id: 13,
      ...
      description: {
        fa: "آیفون ۱۳ پرو مکس به خاطر باتری قدرتمند و عملکرد پایدار...",
        en: "The iPhone 13 Pro Max became extremely popular thanks to its long‑lasting battery..."
      }
    },
    {
      id: 12,
      ...
      description: {
        fa: "آیفون ۱۲ پرو مکس آغازگر طراحی مدرن آیفون با لبه‌های تخت...",
        en: "The iPhone 12 Pro Max introduced Apple's modern flat‑edge design..."
      }
    }
  ];
